...
interface GameLoadingScreenProps {
  team1Name: string;
  team2Name: string;
  onComplete: (finalScores: { team1: number; team2: number }) => void;
}

const GameLoadingScreen = ({ team1Name, team2Name, onComplete }: GameLoadingScreenProps) => {
  const [currentInning, setCurrentInning] = useState(1);
  const [team1InningScores, setTeam1InningScores] = useState<number[]>(Array(12).fill(0));
  const [team2InningScores, setTeam2InningScores] = useState<number[]>(Array(12).fill(0));
